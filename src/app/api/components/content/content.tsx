...
import { DevSidePanel } from '../side-panel/panel';
import { DevNavSectionProps } from '../panel/components/nav-section/section';
...
const getAllPages = (sections: DevNavSectionProps[]): { label: string; href: string }[] => {
    const pages: { label: string; href: string }[] = [];
    
    const traverse = (items: DevNavSectionProps[]) => {
        items.forEach(item => {
