...
export default function Page() {
    ...
    const ALLOW_REPORT = usePermission(PERMISSIONS.FM_REPORT);
    ...
    return (
        <>
            <PlatformHead
                ...
                description='Excel-отчёты финансовых операций, кредитов, категорий трат/доходов, долговых контрагентов.'
                searchProps={{
            ...
            {docsList.length === 0 ? (
                <PlatformEmptyCanvas 
                    ...
                    description='Здесь будут появляться сгенерированные финансовые отчёты.'
                    icon={<Folder />}
                />
            ) : (
                <>
