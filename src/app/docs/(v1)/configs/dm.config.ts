...
import { DOCS_LINK_DM_ANALYSIS, DOCS_LINK_DM_DEALS, DOCS_LINK_DM_DEALS_CLIENT, DOCS_LINK_DM_DEALS_EMPLOYEES, DOCS_LINK_DM_DEALS_OPERATIONS, DOCS_LINK_DM_DEALS_STRUCTURE, DOCS_LINK_DM_DOCS, DOCS_LINK_DM_STATUSES, DOCS_LINK_DM_TYPES } from "../internal.config";
