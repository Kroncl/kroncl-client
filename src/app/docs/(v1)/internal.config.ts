...
export const DOCS_LINK_ACCOUNT_OVERVIEW = DOCS_LINK_ACCOUNT + '/overview';
export const DOCS_LINK_ACCOUNT_SECURITY = DOCS_LINK_ACCOUNT + '/fingerprints';
...
export const DOCS_LINK_FM = DOCS_LINK_MODULES + '/fm';
export const DOCS_LINK_HRM =  DOCS_LINK_MODULES + '/hrm';
export const DOCS_LINK_CRM =  DOCS_LINK_MODULES + '/crm';
export const DOCS_LINK_WM =  DOCS_LINK_MODULES + '/wm';
export const DOCS_LINK_DM =  DOCS_LINK_MODULES + '/dm';
